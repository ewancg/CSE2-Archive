...
extern BOOL gMirrorMode;
extern unsigned int gSpriteScale;

extern FONT_DATA gbFontData;
extern BOOL gbVsync;

extern size_t font_width;
extern size_t font_height;
extern size_t title_width;
extern size_t title_height;
